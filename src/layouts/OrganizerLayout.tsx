...
import { LogOut, LayoutDashboard, List, Trophy } from 'lucide-react';
    ...
    <div className={cn("flex min-h-[100dvh] w-full bg-[#0a0a0a] text-gray-200 font-sans", className)}>
      ...
      <div className="w-64 bg-[#111] border-r border-gray-800 flex flex-col shrink-0">
        <div className="p-6 border-b border-gray-800">
          <h1 className="font-display text-xl text-gold uppercase tracking-widest">Convergence</h1>
          <p className="text-xs text-gray-500 uppercase tracking-widest mt-1">Organizer Panel</p>
        </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive ? "bg-gold/10 text-gold border-r-2 border-gold" : "text-gray-400 hover:text-gray-200 hover:bg-gray-800/50"
                )}
              >
        ...
        <div className="p-4 border-t border-gray-800">
          <button 
            ...
            className="w-full flex items-center gap-3 px-2 py-2 text-sm text-gray-400 hover:text-red-400 transition-colors"
          >
      ...
      <div className="flex-1 flex flex-col h-[100dvh] overflow-hidden">
        {title && (
          <header className="px-8 py-6 border-b border-gray-800 shrink-0 bg-[#0a0a0a]">
